...
class TestMemoryStore:
    ...
    def test_add_memory_to_root(self, temp_storage_file):
        ...
        result = store.add_memory(
            position=[], description="test", content="test content", tags=["tag1"], author="user"
        )
    ...
    def test_add_memory_nested(self, temp_storage_file):
        ...
        # Add child
        result = store.add_memory(
            position=["parent"], description="child", content="child content", tags=["nested"], author="user"
        )
    ...
    def test_edit_memory(self, temp_storage_file):
        ...
        result = store.edit_memory(
            ["original"], description="updated", content="new content", tags=["new", "updated"]
        )
