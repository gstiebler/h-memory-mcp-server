...
class TestMemory:
    def test_memory_creation(self):
        ...
        memory = Memory(
            description="test memory", content="test content", tags=["test", "sample"], author="test_user"
        )
    ...
    def test_memory_creation_with_defaults(self):
        ...
        memory = Memory(description="minimal", author="user")
    ...
    def test_to_dict(self):
        ...
        memory = Memory(description="test", content="content", tags=["tag1"], author="user")
    ...
    def test_round_trip_serialization(self):
        ...
        original = Memory(description="test", content="content", tags=["tag1", "tag2"], author="user")
