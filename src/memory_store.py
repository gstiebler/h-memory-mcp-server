...
class MemoryStore:
    ...
    def add_memory(self, position: Position, description: str, 
                   content: Optional[str], tags: List[str], 
    ...
    def edit_memory(self, position: Position, description: Optional[str] = None,
